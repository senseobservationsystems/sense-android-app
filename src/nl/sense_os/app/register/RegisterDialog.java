...
public class RegisterDialog extends DialogFragment {
	...
	final EditText addressField = (EditText) view.findViewById(R.id.reg_address);
	final EditText zipCodeField = (EditText) view.findViewById(R.id.reg_zipcode);
	final Spinner countryField = (Spinner) view.findViewById(R.id.reg_country);
	...
	builder.setPositiveButton(R.string.button_reg, new OnClickListener() {
		...
		String email = emailField.getText() == null ? null : emailField.getText()
			.toString();
		String address = addressField.getText() == null ? null : addressField.getText()
			.toString();
		String zipCode = zipCodeField.getText() == null ? null : zipCodeField.getText()
			.toString();
		String country = (String) countryField.getSelectedItem();
		String phone = phoneField.getText() == null ? null : phoneField.getText()
			.toString();
		listener.onSubmit(username, password, password2, email, address, zipCode, country,
			name, surname, phone);
	    }
	});
