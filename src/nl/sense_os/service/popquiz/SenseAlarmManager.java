...
public class SenseAlarmManager {
    ...
    public void createSyncAlarm() {
        ...
        long lastUpdate = mainPrefs.getLong(nl.sense_os.service.SensePrefs.Main.Quiz.SYNC_TIME, 0);
    ...
    private long getNextQuarterHour() {
        final SharedPreferences mainPrefs = ctx.getSharedPreferences(SensePrefs.MAIN_PREFS,
                Context.MODE_PRIVATE);
        final int rate = Integer.parseInt(mainPrefs.getString(nl.sense_os.service.SensePrefs.Main.Quiz.RATE, "0"));
        long period = 0;
        switch (rate) {
            case -1 :
                // often (5 mins)
